...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001872788551').split()]
...
URL = "https://sb-autofilte.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://sb-autofilte.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://sb-autofilte.onrender.com".format(FQDN)
else:
    URL = "https://sb-autofilte.onrender.com".format(FQDN)
